...
class CartTest2Seeder extends Seeder
{
    /**
     * Chạy seeder để tạo dữ liệu giỏ hàng mẫu.
     */
    public function run()
    {
        ...
        // Tạo các mục giỏ hàng (CartItem) ban đầu:
        ...
        // Thêm các mục CartItem bổ sung để test phân trang.
        // Ví dụ: tạo thêm 20 mục CartItem với dữ liệu luân phiên.
        for ($i = 1; $i <= 20; $i++) {
            // Luân chuyển giữa product1 và product2, màu đỏ và xanh, kích thước S và M
            $product = ($i % 2 == 0) ? $product1 : $product2;
            $color   = ($i % 2 == 0) ? $red : $blue;
            $size    = ($i % 2 == 0) ? $sizeS : $sizeM;
            CartItem::create([
                'cart_id'    => $cart->cart_id,
                'product_id' => $product->product_id,
                'color_id'   => $color->color_id,
                'size_id'    => $size->size_id,
                'quantity'   => rand(1, 3), // Số lượng ngẫu nhiên từ 1 đến 3
            ]);
        }
    }
}
