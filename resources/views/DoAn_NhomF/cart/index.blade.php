...
<body>
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr data-cart-item-id="{{ $item->cart_items_id }}">
                            ...
                            <!-- Form bao bọc toàn bộ phần input số lượng và nút submit -->
                            <form action="{{ route('cart.checkout', $item->getKey()) }}" method="GET">
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        <div class="input-group-btn">
                                            <!-- Nút trừ, loại="button" để không submit form khi nhấn -->
                                ...
                                <td>
                                    <!-- Nút submit để add to checkout; khi nhấn, nó sẽ gửi giá trị 'quantity' hiện hành -->
                                    <button type="submit" class="btn btn-primary mt-2">Add to Checkout</button>
                                </td>
                            </form>
            ...
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Nút xóa dựa trên route đã định nghĩa -->
                            <a href="{{ route('cart.checkout.delete', $item->getKey()) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Toggle phần danh sách checkout khi bấm nút
            document.getElementById('toggleCheckoutList').addEventListener('click', function() {
                ...
                if (checkoutList.style.display === 'none' || checkoutList.style.display === '') {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            totalCells.forEach(function(cell) {
                // Lấy nội dung của ô, ví dụ: "$200.00"
