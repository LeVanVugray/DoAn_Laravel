                    ...
                    <div class="widget-content nopadding">
                        ...
                        <form action="{{route('post_from_add_user')}}" method="post" class="form-horizontal"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="email" value="{{ old('email') }}" required
                                        autofocus /> * <br>
                                    @if ($errors->has('email'))
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="password" value="{{ old('password') }}"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="phone" value="{{ old('phone') }}" required
                                        autofocus /> * <br>
                                    @if ($errors->has('phone'))
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="address" value="{{ old('address') }}"
                                        required autofocus /> * <br>
                            ...
                            <!-- <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    @if ($errors->has('role'))
                                <spanstyle="color: red;"  class="text-danger">{{ $errors->first('role') }}</span>
                                @endif
                                </div>
                            </div> -->
                            <div class="control-group">
